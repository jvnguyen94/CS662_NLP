...
def train_model(model, n_epochs, training_data, c2i, i2c, l2i, i2l, validation_data=None, eval_func=eval_acc):
    """
        ...
        for x_idx, (x, y) in enumerate(pairs):
            ...
            if x_idx % 1000 == 0:
                ...
                if validation_data is not None:
                    acc_score, _ = eval_func(model, validation_data, c2i, i2c, l2i, i2l)
